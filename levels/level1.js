...
[
    ...
    new BackgroundObject("./img/5-background/layers/air.png",720),
    new BackgroundObject("./img/5-background/layers/3-third-layer/2.png",720),
    new BackgroundObject("./img/5-background/layers/2-second-layer/2.png",720),
    new BackgroundObject("./img/5-background/layers/1-first-layer/2.png",720),
   
    new BackgroundObject("./img/5-background/layers/air.png",720 * 2),
    new BackgroundObject("./img/5-background/layers/3-third-layer/1.png",720 * 2),
    new BackgroundObject("./img/5-background/layers/2-second-layer/1.png",720 * 2),
    new BackgroundObject("./img/5-background/layers/1-first-layer/1.png",720 * 2),
    new BackgroundObject("./img/5-background/layers/air.png",720 * 3),
